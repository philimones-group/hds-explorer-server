      ...
      <section className="px-5">
          <div className="cards block-1">
              ...
              <section className="grid gap-5 md:w-fit xl:w-full md:grid-cols-2 xl:flex xl:justify-between xl:mx-auto max-w-[2400px]">
                  ...
                  <CardMain i18n={i18n} label={i18n['dashboard.totalIndividuals']} value={totals?.individuals} icon={<HiUserGroup className="text-[25px] font-thin "/>} iconBg={'bg-costume-blue'} genderStatus={true} maleCount={totals?.residents_male} femaleCount={totals?.residents_female} />
