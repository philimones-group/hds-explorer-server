...
<html>
    ...
    <body>
        ...
        <div id="show-coreFormExtension" class="content scaffold-show" role="main">
            ...
            <f:display bean="coreFormExtension" />
            <g:form resource="${this.coreFormExtension}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.coreFormExtension}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
