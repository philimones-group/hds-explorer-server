...
<html>
    <head>
        ...
        <title><g:message code="round.add.label" args="[entityName]" /></title>
    </head>
    <body>
        ...
        <div id="create-round" class="content scaffold-create" role="main">
            <h1><g:message code="round.add.label" args="[entityName]" /></h1>
            ...
            <g:form resource="${this.round}" method="POST">
                ...
                <fieldset class="buttons">
                    <g:submitButton name="create" class="save" value="${message(code: 'round.create.button.label', default: 'Add')}" />
                </fieldset>
            </g:form>
        </div>
    </body>
