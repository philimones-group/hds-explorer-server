...
enum SyncEntity {
    ...
    HEAD_RELATIONSHIPS (13, "syncEntity.headRelationships.label", "headrelationships"),
    MARITAL_RELATIONSHIPS (14, "syncEntity.maritalRelationships.label", "maritalrelationships"),
    INMIGRATIONS       (15, "syncEntity.inmigrations.label", "inmigrations"),
    OUTMIGRATIONS      (16, "syncEntity.outmigrations.label", "outmigrations"),
    PREGNANCY_REGISTRATIONS (17, "syncEntity.pregnancyRegistrations.label", "pregnancyregistrations"),
    PREGNANCY_OUTCOMES (18, "syncEntity.pregnancyOutcomes.label", "pregnancyoutcomes"),
